...
def toggle_pause():  
    global is_paused
    global Game_State
    if is_paused == True:   #when we press the pause button the initial variable will took the opposite value
        is_paused = False
    else:
        is_paused = True
    Game_State = "Paused"
...
Game_Over = False
Victory = False
#I nitially the Game_State and therefore what the player can actually see is the first-splash-main screen

...
class Restart():
    ...
    def restart_game():
        ...
        Life_board.hideturtle()
        Life_board.clear()
        Initial_Message.setpos(30, 190)
        Initial_Message.write(" {} !!". format(str(Pilot)),  font = ("Microsoft", 36, "normal"))
        instruction_message.hideturtle()
        instruction_message.clear()
        restart = False
...
wn.onkeypress(Quit, "q")
wn.onkeypress(Restart.restart_game, "R")
wn.onkeypress(Restart.restart_game, "r")
...
while running :
    ...
    if Comet != 100 :
            ...
            if lifes > 0:
                ...
                Game_Over = True
                restart_game = True
                if Game_Over == True and running == True and restart  == True  :
                    End_Game()
                    comet_pen.clear()
                    comet_pen.hideturtle()
                    Life_board.hideturtle()
        ...
        Victory = True
        restart_game = True
        if Victory == True and running == True and restart_game == True:

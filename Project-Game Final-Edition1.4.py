...
def Instructions():
    ...
    Life_board.clear()
    intstruction_message.hideturtle()
    intstruction_message.clear()
...
def Instructions2():
    ...
    intstruction_message.write("Hi {},". format(str(Pilot)), align = "center", font = ("Courier 38"))
...
def collision(enemylaser , comet):
    distance = comet.distance(enemylaser)
    if distance <= 20:
        return True
    else:
        return False
...
#Instruction Message
intstruction_message = Message()
intstruction_message.setpos(-5, 100)
intstruction_message.write("Hi {},". format(str(Pilot)), align = "center", font = ("Courier 38"))
